...
export interface VetoPluginInterface extends utils.Interface {
  functions: {
    ...
    "getVotingToken()": FunctionFragment;
    "implementation()": FunctionFragment;
    "initializeBuild(address,(uint8,uint32,uint32,uint64,uint256),address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TAX_PERMISSION_ID",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "VETO_PERMISSION_ID",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getVotingToken",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initializeBuild",
    values: [
      PromiseOrValue<string>,
  ...
  events: {
    ...
    "CancelVote(uint256)": EventFragment;
    ...
    "TaxChanged(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CancelVote"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TaxChanged"): EventFragment;
...
export interface CancelVoteEventObject {
  _proposalId: BigNumber;
}
export type CancelVoteEvent = TypedEvent<[BigNumber], CancelVoteEventObject>;

export type CancelVoteEventFilter = TypedEventFilter<CancelVoteEvent>;
...
export interface TaxChangedEventObject {
  newTax: BigNumber;
  oldTax: BigNumber;
}
export type TaxChangedEvent = TypedEvent<
  [BigNumber, BigNumber],
  TaxChangedEventObject
>;

export type TaxChangedEventFilter = TypedEventFilter<TaxChangedEvent>;
...
export interface VetoPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VetoPluginInterface;
  ...
  functions: {
    TAX_PERMISSION_ID(overrides?: CallOverrides): Promise<[string]>;
    ...
    VETO_PERMISSION_ID(overrides?: CallOverrides): Promise<[string]>;
    ...
    getVotingToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "CancelVote(uint256)"(_proposalId?: null): CancelVoteEventFilter;
    CancelVote(_proposalId?: null): CancelVoteEventFilter;
    ...
    "TaxChanged(uint256,uint256)"(
      newTax?: null,
      oldTax?: null
    ): TaxChangedEventFilter;
    TaxChanged(newTax?: null, oldTax?: null): TaxChangedEventFilter;
  ...
  estimateGas: {
    TAX_PERMISSION_ID(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    VETO_PERMISSION_ID(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getVotingToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    TAX_PERMISSION_ID(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    getVotingToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
